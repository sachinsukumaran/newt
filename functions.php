...
if ( ! function_exists( 'owt_setup' ) ) :
	...
	function owt_setup() {
		 ...
		 * If you're building a theme based on owt, use a find and replace
		 * to change 'owt' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'owt', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'owt_custom_background_args', array(
...
add_action( 'after_setup_theme', 'owt_setup' );
 ...
 */
function owt_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'owt_content_width', 640 );
}
add_action( 'after_setup_theme', 'owt_content_width', 0 );
 ...
 */
function owt_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'owt' ),
		'id'            => 'sidebar-1',
...
function owt_scripts() {
  wp_enqueue_style( 'owt_bootstrap_css', get_template_directory_uri() . '/css/bootstrap.min.css' );
	...
	wp_enqueue_style( 'owt-load-fa', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' );
...
add_action( 'wp_enqueue_scripts', 'owt_scripts' );
